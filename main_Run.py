    ...
    def fill_attendance():
        ...
        try:
            ...
            connection = pymysql.connect(
                host='localhost', user='root', password='Fouzan.007', db='manually_fill_attendance')
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/fouza/Desktop/AI--ML/Internship/AICTE - Attendance-Management-System-using-Face-Recognition/Attendance/Manually Attendance/'+DB_table_name+'.csv'
...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            with open('C:/Users/fouza/Desktop/AI--ML/Internship/AICTE - Attendance-Management-System-using-Face-Recognition/StudentDetails/StudentDetails.csv', 'a+') as csvFile:
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    global cursor
                    connection = pymysql.connect(
                        host='localhost', user='root', password='Fouzan.007', db='face_reco_fill')
                    cursor = connection.cursor()
                except Exception as e:
                    print(e)
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/fouza/Desktop/AI--ML/Internship/AICTE - Attendance-Management-System-using-Face-Recognition/Attendance/' + fileName
    ...
    def log_in():
        ...
        if username == 'Faizan':
            if password == 'Fouzan.007':
                ...
                cs = 'C:/Users/fouza/Desktop/AI--ML/Internship/AICTE - Attendance-Management-System-using-Face-Recognition/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
